...

  {
    ...
    findings: [
...

      {
        ...
        packets: [
          { name: "EmptyTankPacket  [high]", does: "nc.multiblock.network.ClearAllFluidsPacket$Handler.processMessage` / `nc/mul  \u00b7  channel nuclearcraft", couldDo: "If the tile at a client-chosen BlockPos is an `IMultiblockPart` whose multiblock is `IMultiblockFluid`, calls `multiblock.clearAllFluids()` - drains every fluid tank of an entire multiblock\u2026" },
...

      {
        ...
        packets: [
          ...
          { name: "MessageSirenSong  [low]", does: "MessageSirenSong.onServerReceived` / `MessageSirenSong.java:60-66  \u00b7  channel iceandfire` (llibrary `@NetworkWrapper`)", couldDo: "Client-sendable (registered on both sides via llibrary `AbstractMessage.registerOnSide` \u2192 true)." },
          { name: "MessageDeathWormHitbox  [low]", does: "MessageDeathWormHitbox.onServerReceived` / `MessageDeathWormHitbox.java:60-6  \u00b7  channel iceandfire` (llibrary `@NetworkWrapper`)", couldDo: "" },
          { name: "MessageDaytime  [low]", does: "MessageDaytime.onServerReceived` / `MessageDaytime.java:60-61  \u00b7  channel iceandfire` (llibrary `@NetworkWrapper`)", couldDo: "" },
          { name: "MessageGetMyrmexHive  [low]", does: "MessageGetMyrmexHive.onServerReceived` / `MessageGetMyrmexHive.java:61-67  \u00b7  channel iceandfire` (llibrary `@NetworkWrapper`)", couldDo: "" },
          { name: "MessageSetMyrmexHiveNull  [low]", does: "MessageSetMyrmexHiveNull.onServerReceived` / `MessageSetMyrmexHiveNull.java:  \u00b7  channel iceandfire` (llibrary `@NetworkWrapper`)", couldDo: "" },
          { name: "MessageUpdatePixieHouse  [low]", does: "MessageUpdatePixieHouse.onServerReceived` / `MessageUpdatePixieHouse.java:70  \u00b7  channel iceandfire` (llibrary `@NetworkWrapper`)", couldDo: "" },
          { name: "MessageUpdatePixieHouseModel  [low]", does: "MessageUpdatePixieHouseModel.onServerReceived` / `MessageUpdatePixieHouseMod  \u00b7  channel iceandfire` (llibrary `@NetworkWrapper`)", couldDo: "No server-side effect." },
          { name: "MessageUpdatePixieJar  [low]", does: "MessageUpdatePixieJar.onServerReceived` / `MessageUpdatePixieJar.java:60-61  \u00b7  channel iceandfire` (llibrary `@NetworkWrapper`)", couldDo: "no server-side effect." },
          { name: "MessageUpdatePodium  [low]", does: "MessageUpdatePodium.onServerReceived` / `MessageUpdatePodium.java:64-65  \u00b7  channel iceandfire` (llibrary `@NetworkWrapper`)", couldDo: "no server-side effect." },
        ],
...

      {
        ...
        packets: [
          ...
          { name: "MessageChangeHotbar  [medium]", does: "MessageChangeHotbar.handleMessage  \u00b7  channel autoreglib` (defined in AutoRegLib)", couldDo: "Client sends a bar index (1-3);" },
...

      {
        ...
        packets: [
          { name: "PacketButtonID  [high]", does: "reborncore.common.logic.PacketButtonID.processData  \u00b7  channel rc&reborncore.&<crc5>` (dynamically generated)", couldDo: "A client sends a BlockPos + ID." },
...

      {
        ...
        packets: [
          ...
          { name: "SAVE_SIGN  [low]", does: "PacketHandlerServer.handlePacket  \u00b7  channel variedcommodities` (FMLEventChannel, `VariedCommodities.java:97`)", couldDo: "Client sends a `BlockPos` + text;" },
...

      {
        ...
        version: "1.1.23",
        cwe: "CWE-862 Missing Authorization",
        title: "SkillsPacket: sets the sender's skill levels from client-supplied data and, if `levelSpend >",
        packets: [
          { name: "SkillsPacket  [high]", does: "levelup2.network.SkillPacketHandler.handlePacket  \u00b7  channel levelupskills` (FMLEventChannel)", couldDo: "A client sends a button + levelSpend + skill data." },
          { name: "ClassChangePacket  [low]", does: "levelup2.network.SkillPacketHandler.handleClassChange  \u00b7  channel levelupclasses` (FMLEventChannel)", couldDo: "Client picks its own class/specialization (mining/craft/combat bonus)." },
        ],
...

      {
        ...
        version: "2.0.8",
        cwe: "CWE-862 Missing Authorization",
        title: "PacketMainhandAttack: looks up the entity by ID and calls `Helpers.attackTargetEntityItem(player",
        packets: [
...

      {
        ...
        version: "1.4.2",
        cwe: "CWE-862 Missing Authorization",
        title: "PacketMountSpecial: A client can fire 8 fireballs from any entity (including another player's or a",
        packets: [
          { name: "PacketMountSpecial  [high]", does: "com.Fishmod.mod_LavaCow.message.PacketMountSpecial.onMessage` / `scratch/pac  \u00b7  channel mod_lavacow", couldDo: "Looks up any entity by client-supplied entity ID (`world.func_73045_a(message.Id)`), then spawns 8 `EntitySmallFireball`s from that entity aimed along its look vector, plus plays a sound." },
        ],
...

      {
        ...
        version: "1.1.2",
        cwe: "CWE-862 Missing Authorization",
        title: "PacketBottledCloudJump: zeroes the sender's vertical velocity and spawns cloud particles (and plays a",
        packets: [
...

      {
        ...
        packets: [
          ...
          { name: "MessageSyncRequest  [low]", does: "MessageSyncRequest.onMessage` / `MessageSyncRequest.java:21-25  \u00b7  channel lycanitesmobs", couldDo: "" },
          { name: "MessageGUIRequest  [low]", does: "MessageGUIRequest.onMessage` / `MessageGUIRequest.java:31-34  \u00b7  channel lycanitesmobs", couldDo: "" },
          ...
          { name: "MessageBeastiary  [low]", does: "MessageBeastiary.onMessage` / `MessageBeastiary.java:49-66  \u00b7  channel lycanitesmobs", couldDo: "client-bound;" },
          { name: "MessageCreatureKnowledge  [low]", does: "MessageCreatureKnowledge.onMessage` / `MessageCreatureKnowledge.java:37-43  \u00b7  channel lycanitesmobs", couldDo: "client-boundary." },
          { name: "MessagePlayerStats  [low]", does: "MessagePlayerStats.onMessage` / `MessagePlayerStats.java:35-43  \u00b7  channel lycanitesmobs", couldDo: "client-boundary." },
          { name: "MessageCreature  [low]", does: "MessageCreature.onMessage` / `MessageCreature.java:39-51  \u00b7  channel lycanitesmobs", couldDo: "client-boundary." },
          { name: "MessageEntityPickedUp  [low]", does: "MessageEntityPickedUp.onMessage` / `MessageEntityPickedUp.java:39-51  \u00b7  channel lycanitesmobs", couldDo: "client-boundary." },
          { name: "MessageEntityPerched  [low]", does: "MessageEntityPerched.onMessage` / `MessageEntityPerched.java:39-51  \u00b7  channel lycanitesmobs", couldDo: "client-boundary." },
          { name: "MessageEntityVelocity  [low]", does: "MessageEntityVelocity.onMessage` / `MessageEntityVelocity.java:59-65  \u00b7  channel lycanitesmobs", couldDo: "client-boundary." },
          { name: "MessageWorldEvent  [low]", does: "MessageWorldEvent.onMessage` / `MessageWorldEvent.java:41-49  \u00b7  channel lycanitesmobs", couldDo: "client-boundary." },
          { name: "MessageMobEvent  [low]", does: "MessageMobEvent.onMessage` / `MessageMobEvent.java:41-49  \u00b7  channel lycanitesmobs", couldDo: "client-boundary." },
          { name: "MessageSummoningPedestalStats  [low]", does: "MessageSummoningPedestalStats.onMessage` / `MessageSummoningPedestalStats.ja  \u00b7  channel lycanitesmobs", couldDo: "client-boundary." },
        ],
...

      {
        ...
        version: "1.9.11",
        cwe: "CWE-862 Missing Authorization",
        title: "SRPPacketMeleeRange: server attacks any entity by ID if the sender holds an `IHaveReach` weapon and",
        packets: [
          ...
          { name: "SRPPacketBiomeChange  [low]", does: "SRPPacketBiomeChange.Handler.handle` / `SRPPacketBiomeChange.java:54-56  \u00b7  channel SRParasites", couldDo: "client-boundary." },
          { name: "SRPPacketFog  [low]", does: "SRPPacketFog.Handler.handle` / `SRPPacketFog.java:46-48  \u00b7  channel SRParasites", couldDo: "client-boundary." },
          { name: "SRPPacketMovingSound  [low]", does: "SRPPacketMovingSound.Handler.handle` / `SRPPacketMovingSound.java:55-57  \u00b7  channel SRParasites", couldDo: "client-boundary." },
          { name: "SRPPacketParticle  [low]", does: "SRPPacketParticle.Handler.handle` / `SRPPacketParticle.java:68-93  \u00b7  channel SRParasites", couldDo: "client-boundary." },
          { name: "SRPPacketEntityBodyDead  [low]", does: "SRPPacketEntityBodyDead.Handler.handle` / `SRPPacketEntityBodyDead.java:56-6  \u00b7  channel SRParasites", couldDo: "client-boundary." },
        ],
...

      {
        ...
        version: "",
        cwe: "CWE-862 Missing Authorization",
        title: "MessageRequestPassengerChest: Client requests the chest-inventory of a `EntityChestPassenger` riding the",
        packets: [
...

      {
        ...
        packets: [
          { name: "SyncPacket  [medium]", does: "BulkSyncPacket` \u2192 `SyncPacket.processEntry` \u2192 `cfg.saveQuietly()  \u00b7  channel carbonconfig:networking", couldDo: "Same as `SyncPacket` but for a batch of config entries - deserializes client-supplied config entries into a named config and saves it, with no op/permission check." },
          { name: "BulkSyncPacket  [medium]", does: "BulkSyncPacket` \u2192 `SyncPacket.processEntry` \u2192 `cfg.saveQuietly()  \u00b7  channel carbonconfig:networking", couldDo: "Same as `SyncPacket` but for a batch of config entries - deserializes client-supplied config entries into a named config and saves it, with no op/permission check." },
        ],
...

      {
        ...
        version: "1.6.22",
        cwe: "CWE-862 Missing Authorization",
        title: "MessageApplyHealingItem: server consumes one item from that hand and sets it as the active healer on",
        packets: [
...

      {
        ...
        version: "1.4.3",
        cwe: "CWE-862 Missing Authorization",
        title: "AddedStructureMarkersPacket: Takes a client-supplied `atlasID`, `dimension`, and a list of `Marker`s (id",
        packets: [
...

      {
        ...
        version: "1.12.2",
        cwe: "CWE-862 Missing Authorization",
        title: "MobModsPacket: the server looks up the entity's infernal modifier and replies with the",
        packets: [
...

      {
        ...
        packets: [
          { name: "PacketSyncSlotVisibility  [medium]", does: "PacketSyncSlotVisibility.handle  \u00b7  channel librarianlib` (AutoRegLib packet registry)", couldDo: "Client sends a `boolean[]` visibility mask;" },
        ],
...

      {
        ...
        packets: [
          { name: "quest_action  [low]", does: "NetQuestAction.onServer  \u00b7  channel BQ_NET_CHAN` (disc 0, `PacketQuesting`; `BetterQuesting.java:98-104`)", couldDo: "Client sends `action` (0=claim, 1=detect) plus an array of `questIDs`." },
...

      {
        ...
        packets: [
          { name: "PacketEntityData  [low]", does: "PacketEntityData.PacketHandler.onMessage  \u00b7  channel dsurround` (`Network.java:81`)", couldDo: "`Side.CLIENT` (server\u2192client, disc 3) - NOT client-sendable." },
...

      {
        ...
        packets: [
          { name: "GrappleAttachMessage  [low]", does: "GrappleAttachMessage.Handler.onMessage` / `GrappleAttachMessage.java:117-151  \u00b7  channel grapplemodchannel", couldDo: "Not actually client-sendable - registered `Side.CLIENT` (`grapplemod.java:342`)." },
          { name: "GrappleDetachMessage  [low]", does: "GrappleDetachMessage.Handler.onMessage` / `GrappleDetachMessage.java:39-62  \u00b7  channel grapplemodchannel", couldDo: "Not actually client-sendable (Side.CLIENT, `grapplemod.java:348`)." },
          { name: "DetachSingleHookMessage  [low]", does: "DetachSingleHookMessage.Handler.onMessage` / `DetachSingleHookMessage.java:4  \u00b7  channel grapplemodchannel", couldDo: "" },
          { name: "GrappleAttachPosMessage  [low]", does: "GrappleAttachPosMessage.Handler` / `GrappleAttachPosMessage.java:55-65  \u00b7  channel grapplemodchannel", couldDo: "" },
          { name: "SegmentMessage  [low]", does: "SegmentMessage.Handler` / `SegmentMessage.java:69-79  \u00b7  channel grapplemodchannel", couldDo: "" },
          { name: "LoggedInMessage  [low]", does: "LoggedInMessage.Handler` / `LoggedInMessage.java:117-139  \u00b7  channel grapplemodchannel", couldDo: "" },
        ],
...

      {
        ...
        packets: [
          { name: "RegisterTileIdPacket  [low]", does: "RegisterTileIdPacket.process  \u00b7  channel antiqueatlas` (SimpleNetworkWrapper, `PacketDispatcher.java:40`)", couldDo: "Client sends an arbitrary tile-name string;" },
...

      {
        ...
        packets: [
          { name: "MessageDataSync  [low]", does: "MessageDataSync.handleMessage` / `MessageDataSync.java:50-71  \u00b7  channel scalinghealth", couldDo: "client-boundary." },
          { name: "MessageDebugData  [low]", does: "MessageDebugData.handleMessage` / `MessageDebugData.java:27-33  \u00b7  channel scalinghealth", couldDo: "client-boundary." },
          { name: "MessageMarkBlight  [low]", does: "MessageMarkBlight.handleMessage` / `MessageMarkBlight.java:47-62  \u00b7  channel scalinghealth", couldDo: "client-boundary." },
          { name: "MessagePlaySound  [low]", does: "MessagePlaySound.handleMessage` / `MessagePlaySound.java:47-59  \u00b7  channel scalinghealth", couldDo: "client-boundary." },
          { name: "MessageWorldDataSync  [low]", does: "MessageWorldDataSync.handleMessage` / `MessageWorldDataSync.java:40-52  \u00b7  channel scalinghealth", couldDo: "client-boundary." },
        ],
...

      {
        ...
        packets: [
          { name: "DamagePacket  [low]", does: "team.creative.enhancedvisuals.common.packet.DamagePacket.executeClient  \u00b7  channel creativemd` (CreativeCore framework channel - EnhancedVisuals registers its packets via `CreativeCorePacket.registerPacket`)", couldDo: "Client-bound visual packet." },
          { name: "ExplosionPacket  [low]", does: "team.creative.enhancedvisuals.common.packet.ExplosionPacket.executeClient  \u00b7  channel creativemd` (CreativeCore framework)", couldDo: "Client-bound visual packet." },
          { name: "PotionPacket  [low]", does: "team.creative.enhancedvisuals.common.packet.PotionPacket.executeClient  \u00b7  channel creativemd` (CreativeCore framework)", couldDo: "Client-bound visual packet." },
        ],
...

      {
        ...
        packets: [
          { name: "InventorySlotSyncPacket  [low]", does: "InventorySlotSyncPacket.handleClientSafe  \u00b7  channel inspirations` (`InspirationsNetwork.java:39`)", couldDo: "`Side.CLIENT` (`registerPacketClient`, `InspirationsNetwork.java:43`) - NOT client-sendable." },
...

      {
        ...
        packets: [
          { name: "task_checkbox  [low]", does: "NetTaskCheckbox.onServer  \u00b7  channel BQ_STANDARD` (uses BetterQuesting's `PacketTypeRegistry`; `BQ_Standard.java:71`)", couldDo: "Client sends `questID`/`taskID`;" },
...

      {
        ...
        packets: [
          { name: "PacketOpenBaublesInventory  [low]", does: "PacketOpenBaublesInventory.onMessage  \u00b7  channel baubles` (`PacketHandler.java:19`)", couldDo: "`Side.SERVER` (disc 0)." },
...

      {
        ...
        packets: [
          { name: "PacketHatGuiOpen  [low]", does: "PacketHatGuiOpen.handle  \u00b7  channel classyhats` (librarianlib `@PacketRegister(value=Side.SERVER)`)", couldDo: "Opens the hat GUI for the sender with a client-supplied `target` int." },
          { name: "PacketSyncLastSelectedSection  [low]", does: "PacketSyncLastSelectedSection.handle  \u00b7  channel classyhats` (`@PacketRegister(value=Side.SERVER)`)", couldDo: "Sets the sender's `CapabilityHatContainer` current-hat-section to a client int." },
        ],
...

      {
        ...
        packets: [
          { name: "PacketGuiAction  [low]", does: "ivorius.ivtoolkit.network.PacketGuiAction  \u00b7  channel (none - library registers no channel)", couldDo: "Not actually client-sendable in this pack - IvToolkit itself registers NO network channel, and no mod in the pack registers `PacketGuiAction` on its own wrapper." },
          { name: "PacketTileEntityClientEvent  [low]", does: "ivorius.ivtoolkit.network.PacketTileEntityClientEvent  \u00b7  channel (none - library)", couldDo: "Not client-sendable in this pack - same as PacketGuiAction, library-only with no in-pack registration." },
        ],
...

      {
        ...
        packets: [
          { name: "DamageMessage  [low]", does: "DamageMessage.MessageHandlerClient.onMessage` / `DamageMessage.java:56-76  \u00b7  channel TestDummy", couldDo: "client-boundary." },
          { name: "SyncEquipmentMessage  [low]", does: "SyncEquipmentMessage.MessageHandlerClient.onMessage` / `SyncEquipmentMessage  \u00b7  channel TestDummy", couldDo: "client-boundary." },
        ],
...

      {
        ...
        packets: [
          { name: "MessageDismountChair  [low]", does: "MessageDismountChair.MessageHolder.onMessage  \u00b7  channel rustic` (`PacketHandler.java:19`)", couldDo: "`Side.SERVER` (disc 2)." },
...

      {
        ...
        packets: [
          { name: "MessageSyncConfigs  [low]", does: "MessageSyncConfigs.onMessage  \u00b7  channel sereneseasons` (`PacketHandler.java:18`)", couldDo: "`Side.CLIENT` (disc 4) - NOT client-sendable." },
...

      {
        ...
        packets: [
          { name: "PressKeyPacket  [low]", does: "PressKeyPacket.onMessage  \u00b7  channel CallableHorses` (`CommonProxy.java:42`)", couldDo: "`Side.SERVER` (disc 0)." },
        ],
...

      {
        ...
        packets: [
          { name: "SyncKeybindPacket  [low]", does: "SyncKeybindPacketHandler.onMessage  \u00b7  channel CarryOn` (`CommonProxy.java:41`)", couldDo: "`Side.SERVER` (disc 0)." },
        ],
...

      {
        ...
        packets: [
          { name: "SyncNetworkHandler.handlePlayerPacket  [low]", does: "cd4017be.lib.BlockGuiHandler.onPlayerPacketReceived` / `scratch/packetaudit/  \u00b7  channel 4017", couldDo: "Deprecated generic dispatch." },
        ],
...

      {
        ...
        version: "1.7.20",
        cwe: "CWE-862 Missing Authorization",
        title: "SurvivalTabMessage: Server handler posts a `SurvivalTabClickEvent(message.label, player)` on the",
        packets: [
          { name: "SurvivalTabMessage  [low]", does: "SurvivalTabMessage.onServerReceived  \u00b7  channel llibrary` (SimpleNetworkWrapper via `@NetworkWrapper`)", couldDo: "Client-sendable (registered on both sides)." },
        ],
...

      {
        ...
        packets: [
          { name: "CheckPinPacket  [low]", does: "CheckPinPacket.Handler.onMessage  \u00b7  channel locks` (`LocksNetworks.java:26`)", couldDo: "`Side.SERVER` (disc 3)." },
        ],
...

      {
        ...
        packets: [
          { name: "PacketRequestProfile  [low]", does: "PacketRequestProfile.Handler.onMessage  \u00b7  channel lostcities` (`ModSetup.java:48`)", couldDo: "`Side.SERVER`." },
        ],
...

      {
        ...
        packets: [
          { name: "CPacketHandlerSyncConfig  [low]", does: "CPacketHandlerSyncConfig.onMessage  \u00b7  channel reachfix` (`ReachFix.java:63`)", couldDo: "`Side.CLIENT` (registered `ReachFix.java:69`) - NOT client-sendable." },
        ],
...

      {
        ...
        packets: [
          { name: "MessageOpenBackpack  [low]", does: "MessageOpenBackpack.Handler.handle  \u00b7  channel wearablebackpacks` (`BackpacksChannel.java:36`)", couldDo: "`Side.SERVER` (disc 3)." },
        ],
